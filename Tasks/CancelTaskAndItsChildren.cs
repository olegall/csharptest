...
public class CancelTaskAndItsChildren
{
    public static async Task Main()
    {
        ...
        // Pass the token to the user delegate, and also to the task so it (token?) can
    ...
    static void DoSomeWork(int taskNum, CancellationToken ct)
    {
        ...
        // NOTE!!! A "TaskCanceledException was unhandled by user code" error will be raised here if "Just My Code"
        // is enabled on your computer. On Express editions JMC is enabled and cannot be disabled. 
        // The exception is benign. Just press F5 to continue executing your code.
